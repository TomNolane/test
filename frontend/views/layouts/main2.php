...
<body cz-shortcut-listen="true">
	<div class="container">
		...
		<div class="left-column">
			<h1>
				Как я накачал тело за 1 месяц
			</h1>
			<p style="font-size: 13px;">
				Опубликовано <span class="startdate">29.01.2018</span> | Автор: vladimir
			</p>
			<img style="width: 100%;" src="main-photo.jpg">
		
			<p>
				Привет всем, друзья! Помните, я полгода назад вам говорил, что хочу <b>привести тело в порядок</b> и спрашивал совета, как это сделать в КОРОТКИЕ сроки?
			</p>
			<p>
				Как-то посмотрел я на себя в зеркало и увидел, что мне совсем не нравится мое тело. Я люблю себя, но все-таки многое я все же подкорректировал бы. Например, я решил сделать себе красивый пресс и убрать начинающий уже расти животик, это раз. Во вторых, я решил сделать себе красивый бицепс. И третье это прокачать грудак.
			</p>
			<p>
				Я перепробовал все возможные способы. Сначала занимался дома, таскал все тяжести, не давая себе ни минуты продыха. Потом пошел в тренажерный зал, взял годовой абонемент, и первые месяца 3 я просто пропадал там: руки ворвал, спина от напряжения не сгибалась, да и чувствовал я себя, будто меня выжали в соковыжималке. 
			</p>
			<h2>
			...
			<img style="float: right; margin: 0px 0px 10px 10px; max-width: 250px;" src="biceps.jpg">
			<p>
				Я узнал все подробнее. Оказывается, это специальный миостимулятор точечного воздействия. Вот как действует EMS Trainer:<br>
1. Миостимулятор <b>посылает микроимпульсы</b> в мышцы и подкожный жир. В результате они получают то же воздействие, что и от <b>бомбовой тренировки</b> спортсмена;<br>
2. <b>Не нужно каждый раз пахать в зале</b>, чтобы взорвать мышцы, можно просто нацепить EMS Trainer на 20 минут в день и он сделает все за вас;<br>
3. <b>Мышцы КАЧАЮТСЯ</b>, потому что микроимпульсы равны тренировочным нагрузкам;<br>
4. <b>Избавляет от лишнего веса</b>, так как точечно воздействует на жировую ткань;<br>
5. <b>Можно нацепить куда угодно</b> - ноги, бедра, грудь, бицепс, плюс - <b>разные режимы тренировок!</b><br>
			</p>
			...
			<img style="width: 100%; margin-bottom: 5px;" src="do_posle.jpg">
			<p>
			...
			<div style="text-align: center;">
				<p style="text-align: left; font-size: 20px;">Комментарии: </p>
			</div>
			<div class="vk-container">
				
				<div class="vk-comment-load comment-id-1">
					<div class="vk-avatar">
						<img src="16000000.jpg">
					</div>
					<div class="vk-comment-name yelpay-target">
						Александр Зеленин
					</div>
				...
				<div class="vk-comment-load">
					<div class="vk-avatar">
						<img src="20000000.jpg">
					</div>
					<div class="vk-comment-name yelpay-target">
						Костя Калинин
					</div>
					<div class="vk-comment-text">
						Использую уже второй месяц. Честно - не ожидал ТАКОГО эффекта. Это НЕЧТО. Я к тому же, еще и кучу жира согнал!
						<br>
							<img style="width: 100%;" src="review-1.jpg">
						</div>
						<div class="vk-comment-date">
					...
					<div class="vk-comment">
						...
						<div class="vk-comment-text">
							...
							<br>
								<img style="width: 100%;" src="review-2.jpg">
							</div>
							<div class="vk-comment-date">
						...
						<div class="vk-comment">
							...
							<div class="vk-comment-text">
								...
								<br>
									<img style="width: 100%;" src="review-3.jpg">
								</div>
								<div class="vk-comment-date">
					...
					<div class="sidebar">
						...
						<div class="sidebar-bloggers" onclick="window.open('ibsw.php?ref=&lnk=0&land=&s=&w=&t=&p=&m=&lt=1&domain=');" style="cursor:pointer;">
							<h3>
								Блогеры онлайн
							</h3>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="10000002.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="20000002.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="30000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="40000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="50000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="60000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="70000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="80000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="90000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="10000003.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="11000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="12000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="13000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="14000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="15000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="16000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="17000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="18000001.jpg">
							</div>
							<div class="sidebar-bloggers-avatar yelpay-target">
								<img src="19000001.jpg">
							</div>
							<p style="font-size: 12px; color: rgb(119, 119, 119);">
								И еще 294 без аватара...
							</p>
						</div>
					</div>
					<div class="footer">
